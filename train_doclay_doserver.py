...
IGNORE_ID = -100
MAX_LENGTH = 512
PRETRAIN_MODEL_ID = "/home/muddassir/Desktop/LayoutAnalysis/DEOC/models"
...
# This pipeline applies a series of augmentations to training images.
# Note: The provided pipeline was updated for compatibility with the latest albumentations library.
...
class AugmentedDataset(Dataset):
    ...
    """
    def __init__(self, original_dataset, augmentation_pipeline, apply_augmentation=False, augmentation_prob=0.4):
...
if __name__ == "__main__":
    ...
    #     apply_augmentation=False,  # Enable augmentations for the training set
